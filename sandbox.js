//arrays
var names = ['luigi', 'mario', 'yoshi']; // we can use only string type inside array, also we cannot change names variable to other type f.e. string names = 'milk'
names.push('toad');
...
var mixed = ['ken', 4, 'chun-li', 8, 9]; //now typeScript knows that we want to use two types in array
mixed.push('ryu');
mixed.push(10);
mixed[0] = 3;
//objects
